...
public class Router1 {
      ...
      //obtain the network interfaces list
         ...
         while (ifs.hasMoreElements()) {
            ...
            while (addrs.hasMoreElements()) {
               ...
               //including addresses of the same type of group address
               //if (group.getClass() != addr.getClass()) continue;
               if ((ni.getName().equals("eth1"))) { //alterar em cada router
 ...
 //+ ni.getDisplayName());
   ...
   public static void main(String[] args) throws Exception 
   {
      ...
      DatagramSocket ds = new DatagramSocket(9875, eth);
      DatagramSocket serv = new DatagramSocket(9874);
      ms.joinGroup(group);
         ...
         if(!arrayMsg[4].equals(sucateiro)){//novo pacote
            if(arrayMsg[0].equals("i")) {
                ...
                if(verificaCSI(arrayMsg, cs)){
                    ...
                    DatagramPacket responde = new DatagramPacket(mensagem.getBytes(), mensagem.length(), group, 9875);
                    ds.send(responde);      
                }
                    ...
                    System.out.println("RENCAMINHAR Para SERVIDOR");
                    ...
                    if(data[0].equals("d")){
                       ...
                       System.out.println("Vai reencaminhar DADOS"); 
                       String dados2 = new String( dados.getData());
                       DatagramPacket noticiario = new DatagramPacket(dados2.getBytes(), dados2.length(), group, 9875);
                       ds.send(noticiario);
