...
public class Router5 {
 ...
 //+ ni.getDisplayName());
    ...
    public static boolean verificaPITeth(String [] arrayMsg, Map<String, List<String>> x){
        if(arrayMsg[2].equals("2001:0690:2280:0821::1")) { //ARRANJAR ESTA CONDIÇÃO
            return true;
        }
        else {
            return false;
   ...
   public static void main(String[] args) throws Exception 
   {
       ...
       interfaces.add("2001:0690:2280:0821::1");
      ...
      DatagramSocket dp = new DatagramSocket(9876);
      ms.joinGroup(group);
         ...
         if(!arrayMsg[4].equals(sucateiro)){//novo pacote
            if(arrayMsg[0].equals("i")) {
                ...
                if(verificaCSI(arrayMsg, cs)){
                    ...
                    DatagramPacket responde = new DatagramPacket(mensagem.getBytes(), mensagem.length(), group, 9877);
                    ds.send(responde);
                    ...
                    do{
                        ...
                        if(data[0].equals("d")){
                            ...
                            DatagramPacket noticiario = new DatagramPacket(dados2.getBytes(), dados2.length(), group, 9877);
                            ds.send(noticiario);
