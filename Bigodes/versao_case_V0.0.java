...
public class United {
    public static void main(String[] args) throws UnknownHostException {
        ...
        LinkedHashMap<String,String> contentstore_test = new LinkedHashMap<>(3, 0.75F, true);
        //-----------Construção da PIT-----------------------
            ...
            switch (interesse) {
                case "0":
                    ...
                    if (contentstore_test.containsKey(novo)) {
                        ...
                        String aux =" ";
                        // timestamp
                        // Timestamp timestamp = new Timestamp(System.currentTimeMilis());
                ...
                case "1":
                    ...
                    if (novo2.isEmpty()){
                        ...
                        if (pit_test.containsKey(novo2)){
                            ...
                            // GUARDAR NA CS
                            // TENTATIVA FIFO
                            /*for (int i = 0; contentstore_test.size() < entr; i++){
